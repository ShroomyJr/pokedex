...
CREATE TABLE `Pokemon_Moves` (
    ...
    FOREIGN KEY ('Moves_ID') REFERENCES Types('Moves_ID')
    FOREIGN KEY ('Pokemon_ID') REFERENCES Pokemon('Pokemon_Species_ID')
);
...
CREATE TABLE `Types_Matchups` (
	...
	PRIMARY KEY (`Types_ID`)
    FOREIGN KEY ('Attacking_Type_ID') REFERENCES Types('Types_ID')
    FOREIGN KEY ('Defending_Type_ID') REFERENCES Types('Types_ID')
);
